  ...
  useEffect(() => {
    ...
    async function loadPlan(): Promise<void> {
      try {
        ...
        // Cache local du plan (ORA-063) : lu par session.tsx sans réseau (règle #3)
        // pour le Mode Fantôme Pro (limitDays illimité).
        await AsyncStorage.setItem('user_plan', data?.plan === 'premium' ? 'premium' : 'free')
      } catch {
